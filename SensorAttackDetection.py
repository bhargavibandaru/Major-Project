...
main = tkinter.Tk()
main.title("Detection and Isolation of Sensor Attacks")
...
font = ('times', 16, 'bold')
title = Label(main, text='Detection and Isolation of Sensor Attacks for Autonomous Vehicles: Framework, Algorithms, and Validation')
